package com.dept.web.controller.sq.utils;
...
public class Common
{
	public static final String privateKeyPKCS8 = ProperUtil.getProperty("config", "privateKey");
	public static final String publicKey = ProperUtil.getProperty("config", "publicKey");
	public static final String myProject=ProperUtil.getProperty("config", "project");
	/**
	 * 字符串编码
	 * 
	 * @param sStr
